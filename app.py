...
st.download_button(
    ...
    mime      = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
        ...
        st.markdown(recommendations.generate_recommendations_simple( 
            ...
            has_pis=(pi_df_plot_final_v41 is not None and not pi_df_plot_final_v41.empty),
            target_column_name=target_col_for_results_v41,
            model_rmse=info_modelo_final_v41.get('rmse'), model_mae=info_modelo_final_v41.get('mae'),
            forecast_horizon=st.session_state.forecast_horizon,
            model_params=info_modelo_final_v41.get('model_params') # Pasar los parámetros del modelo
        ))
    else:
