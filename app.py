...
# ... (todo el código de las pestañas de resultados está arriba de esto) ...

# --- Mensajes si las pestañas no se muestran ---
else: # Esto se ejecuta si la condición principal para mostrar las pestañas fue Falsa
    ...
    if uploaded_file is None and df_loaded_check_alt is None: 
        st.info("👋 ¡Bienvenido! Cargue un archivo para comenzar.")
         ...
         (df_processed_check_alt is None or df_processed_check_alt.empty): 
        st.warning("⚠️ Por favor, aplique preprocesamiento a los datos cargados o verifique el resultado.")
    # Puedes añadir un 'else' aquí si df_processed está bien pero model_results está vacío aún.
    # Por ejemplo:
...
st.sidebar.markdown("---"); st.sidebar.info("Asistente de Pronósticos PRO v3.7") # Actualiza la versión si quieres